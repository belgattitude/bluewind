        ...
        return (
            <aside className={`${baseClass}`}>
                <div className={`${baseClass}__brand`}>
                    ...
                    <a className={`${baseClass}__brand-link`} href="#">
                        Blue<span className="text-light">Wind</span>
                    </a>
                ...
                <div className="row row--align-v-center row--align-h-center">
                    <ul className="navList">
                        <li className="navList__heading">
                            Students<i className="far fa-file-alt"></i>
                        </li>
                        <li>
                        ...
                        <li className="navList__heading">
                            lessons<i className="far fa-envelope"></i>
                        </li>
                        <li>
                            <div className="navList__subheading row row--align-v-center">
                                <span className="navList__subheading-icon">
