...
const TextFieldWrapper: React.FC<FieldRenderProps<any, any>> = ({input: {name, onChange, value, ...restInput}, meta, ...rest}) => {
            ...
            render={({ handleSubmit, form, pristine, submitting, values }) => (
                <form onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <Field<number> name="email" component={TextFieldWrapper} placeholder="Email" />
                    </div>
                    <div>
                        <label htmlFor="sex">Sex</label>
                        <Field<number> name="sex" component={TextFieldWrapper} placeholder="Sex" />
                    </div>
                    <div className="buttons">
                        <Button size={'medium'} type="submit" disabled={submitting || pristine}>
                            Submit
                        </Button>
                        <Button size={'medium'} type="button" onClick={form.reset} disabled={submitting || pristine}>
                            Reset
                        </Button>
                    </div>
                    <h1>Abonnements</h1>
